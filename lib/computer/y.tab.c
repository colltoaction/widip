...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ANCHOR = 14,                    /* ANCHOR  */
  YYSYMBOL_ALIAS = 15,                     /* ALIAS  */
  YYSYMBOL_TAG = 16,                       /* TAG  */
  YYSYMBOL_PLAIN_SCALAR = 17,              /* PLAIN_SCALAR  */
  YYSYMBOL_DQUOTE_STRING = 18,             /* DQUOTE_STRING  */
  YYSYMBOL_SQUOTE_STRING = 19,             /* SQUOTE_STRING  */
  YYSYMBOL_YYACCEPT = 20,                  /* $accept  */
  YYSYMBOL_stream = 21,                    /* stream  */
  YYSYMBOL_document_list = 22,             /* document_list  */
  YYSYMBOL_document = 23,                  /* document  */
  YYSYMBOL_optional_newlines = 24,         /* optional_newlines  */
  YYSYMBOL_newlines = 25,                  /* newlines  */
  YYSYMBOL_node = 26,                      /* node  */
  YYSYMBOL_scalar = 27,                    /* scalar  */
  YYSYMBOL_tagged_node = 28,               /* tagged_node  */
  YYSYMBOL_anchored_node = 29,             /* anchored_node  */
  YYSYMBOL_flow_sequence = 30,             /* flow_sequence  */
  YYSYMBOL_flow_seq_items = 31,            /* flow_seq_items  */
  YYSYMBOL_flow_mapping = 32,              /* flow_mapping  */
  YYSYMBOL_flow_map_entries = 33,          /* flow_map_entries  */
  YYSYMBOL_block_sequence = 34,            /* block_sequence  */
  YYSYMBOL_block_seq_items = 35,           /* block_seq_items  */
  YYSYMBOL_block_mapping = 36,             /* block_mapping  */
  YYSYMBOL_block_map_entries = 37          /* block_map_entries  */
};
...
{
       0,   139,   139,   143,   144,   148,   149,   150,   151,   155,
     156,   160,   161,   165,   166,   167,   168,   169,   170,   171,
     172,   176,   177,   178,   182,   186,   197,   198,   202,   203,
     204,   209,   210,   214,   215,   216,   221,   225,   226,   227,
     232,   236,   237,   239
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MAP_KEY", "COLON", "NEWLINE", "ANCHOR", "ALIAS", "TAG", "PLAIN_SCALAR",
  "DQUOTE_STRING", "SQUOTE_STRING", "$accept", "stream", "document_list",
  "document", "optional_newlines", "newlines", "node", "scalar",
  "tagged_node", "anchored_node", "flow_sequence", "flow_seq_items",
  "flow_mapping", "flow_map_entries", "block_sequence", "block_seq_items",
  "block_mapping", "block_map_entries", YY_NULLPTR
};
...
{
       3,    97,    52,    67,    97,    -9,    -8,    -9,    -8,    -9,
      -9,    -9,     7,     3,    -9,    82,    15,    -9,    -9,    -9,
      -9,    -9,    -9,     2,    -9,    12,    19,    -9,    -3,    20,
      -9,    18,    29,    -3,    97,    21,    97,    -9,    -9,    -9,
      15,    97,    -9,    22,    97,    -9,    -9,    97,    97,    -9,
      97,    -3,    -3,    -9,    -3,    97,    27,    -3,    32,    30,
      -3,    97,    97,    32,    32
};
...
{
       0,     0,     0,     0,     0,    11,     9,    20,     9,    21,
      22,    23,     0,     2,     3,     0,     9,    13,    18,    19,
      14,    15,    16,    36,    17,    40,     6,    26,    28,     0,
      31,     0,     0,    37,     0,    10,     0,     1,     4,    12,
       9,     0,     5,    39,    43,     7,    27,    30,     0,    32,
      35,    25,    24,     8,    41,     0,     0,    29,    33,     0,
      38,     0,     0,    42,    34
};
...
{
       0,    12,    13,    14,    34,    35,    16,    17,    18,    19,
      20,    29,    21,    32,    22,    23,    24,    25
};
...
{
      26,    28,    31,    33,    36,     5,     1,    37,     2,    41,
       3,    15,    42,     4,    40,    43,     5,     6,     7,     8,
       9,    10,    11,    45,    15,    44,    46,    41,     5,    47,
      48,    41,    55,    51,    39,    52,    53,    49,    50,    61,
      54,    38,    62,    56,    41,   -41,    57,    58,     0,    59,
       0,     0,     0,     0,    60,     0,     0,     2,    27,     3,
      63,    64,     4,     0,     0,     0,     6,     7,     8,     9,
      10,    11,     2,     0,     3,    30,     0,     4,     0,     0,
       0,     6,     7,     8,     9,    10,    11,     2,     0,     3,
       0,     0,     4,     0,     0,    39,     6,     7,     8,     9,
      10,    11,     2,     0,     3,     0,     0,     4,     0,     0,
       0,     6,     7,     8,     9,    10,    11
};

static const yytype_int8 yycheck[] =
{
       1,     2,     3,     4,     8,    13,     3,     0,     5,    12,
       7,     0,    16,    10,    15,    13,    13,    14,    15,    16,
      17,    18,    19,     4,    13,    13,     6,    12,    13,     9,
      12,    12,    10,    34,    13,    36,    40,     8,     9,    12,
      41,    13,    12,    44,    12,    13,    47,    48,    -1,    50,
      -1,    -1,    -1,    -1,    55,    -1,    -1,     5,     6,     7,
      61,    62,    10,    -1,    -1,    -1,    14,    15,    16,    17,
      18,    19,     5,    -1,     7,     8,    -1,    10,    -1,    -1,
      -1,    14,    15,    16,    17,    18,    19,     5,    -1,     7,
      -1,    -1,    10,    -1,    -1,    13,    14,    15,    16,    17,
      18,    19,     5,    -1,     7,    -1,    -1,    10,    -1,    -1,
      -1,    14,    15,    16,    17,    18,    19
};
...
static const yytype_int8 yystos[] =
{
      ...
      30,    32,    34,    35,    36,    37,    26,     6,    26,    31,
       8,    26,    33,    26,    24,    25,    24,     0,    23,    13,
      26,    12,    24,    13,    13,     4,     6,     9,    12,     8,
       9,    26,    26,    24,    26,    10,    26,    26,    26,    26,
      26,    12,    12,    26,    26
};
...
#line 182 "yaml.y"
                                 { (yyval.node) = (yyvsp[0].node); (yyval.node)->tag = (yyvsp[-2].str); }
#line 1454 "y.tab.c"
    break;
