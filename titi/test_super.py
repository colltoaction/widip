...
from computer import Partial, Language
from computer.super import specializer, specializer_box, interpreter_box
...
def test_compiler_structure():
    from computer.super import specializer_box, interpreter_box
    source = "some_source"
...
def test_compiler_generator_structure():
    from computer.super import specializer_box
